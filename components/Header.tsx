    ...
    <header className="bg-[#013B94]">
      <nav
        ...
        <div>
          <Link href="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-[24px] w-auto" src="logo.svg" alt="logo" />
          </Link>
        </div>
      ...
      <Dialog
        ...
        <div className="fixed inset-0 z-10">
          <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013894] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
